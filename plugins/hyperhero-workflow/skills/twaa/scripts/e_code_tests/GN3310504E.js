...
function pass(detail = '', details = []) {
  return { code: 'GN3310504E', rule: '針對使用內容所必需理解之資訊、概念、程序，提供手語版本。', status: 'pass', message: detail, fix_suggestion: '', details };
}
function fail(message, fix = '', details = []) {
  return { code: 'GN3310504E', rule: '針對使用內容所必需理解之資訊、概念、程序，提供手語版本。', status: 'fail', message, fix_suggestion: fix, details: Array.isArray(details) ? details : [details] };
}
...
export async function check(page) {
  try {
  // 通用 DOM 查詢：針對使用內容所必需理解之資訊、概念、程序，提供手語版本。
    ...
    return { code: 'GN3310504E', rule: '針對使用內容所必需理解之資訊、概念、程序，提供手語版本。', status: 'fail', message: `執行錯誤: ${err.message}`, fix_suggestion: '確認頁面載入完成後再執行', details: [] };
  }
}
...
export const metadata = {
  ...
  level: 'AAA',
  category: 'General',
  rule: '針對使用內容所必需理解之資訊、概念、程序，提供手語版本。',
};
