...
function pass(detail = '', details = []) {
  return { code: 'HM3240800E', rule: '使用導覽工具，指明目前所在網頁在一整組網頁或整個網站中的位置，以及與其他網頁之間的關連性', status: 'pass', message: detail, fix_suggestion: '', details };
}
function fail(message, fix = '', details = []) {
  return { code: 'HM3240800E', rule: '使用導覽工具，指明目前所在網頁在一整組網頁或整個網站中的位置，以及與其他網頁之間的關連性', status: 'fail', message, fix_suggestion: fix, details: Array.isArray(details) ? details : [details] };
}
...
export async function check(page) {
  try {
  // 通用 DOM 查詢：使用導覽工具，指明目前所在網頁在一整組網頁或整個網站中的位置，以及與其他網頁之間的關連性
    ...
    return { code: 'HM3240800E', rule: '使用導覽工具，指明目前所在網頁在一整組網頁或整個網站中的位置，以及與其他網頁之間的關連性', status: 'fail', message: `執行錯誤: ${err.message}`, fix_suggestion: '確認頁面載入完成後再執行', details: [] };
  }
}
...
export const metadata = {
  ...
  level: 'AAA',
  category: 'HTML',
  rule: '使用導覽工具，指明目前所在網頁在一整組網頁或整個網站中的位置，以及與其他網頁之間的關連性',
};
