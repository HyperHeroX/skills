...
function pass(detail = '', details = []) {
  return { code: 'GN3310300E', rule: '針對不常見的字詞，列舉詞彙、提供定義，或提供搜尋線上辭典的功能。', status: 'pass', message: detail, fix_suggestion: '', details };
}
function fail(message, fix = '', details = []) {
  return { code: 'GN3310300E', rule: '針對不常見的字詞，列舉詞彙、提供定義，或提供搜尋線上辭典的功能。', status: 'fail', message, fix_suggestion: fix, details: Array.isArray(details) ? details : [details] };
}
...
export async function check(page) {
  try {
  // 通用 DOM 查詢：針對不常見的字詞，列舉詞彙、提供定義，或提供搜尋線上辭典的功能。
    ...
    return { code: 'GN3310300E', rule: '針對不常見的字詞，列舉詞彙、提供定義，或提供搜尋線上辭典的功能。', status: 'fail', message: `執行錯誤: ${err.message}`, fix_suggestion: '確認頁面載入完成後再執行', details: [] };
  }
}
...
export const metadata = {
  ...
  level: 'AAA',
  category: 'General',
  rule: '針對不常見的字詞，列舉詞彙、提供定義，或提供搜尋線上辭典的功能。',
};
