...
function pass(detail = '', details = []) {
  return { code: 'GN3320501E', rule: '在使用者請求的情況下才開出新視窗，並在鏈結文字中指出此行為。', status: 'pass', message: detail, fix_suggestion: '', details };
}
function fail(message, fix = '', details = []) {
  return { code: 'GN3320501E', rule: '在使用者請求的情況下才開出新視窗，並在鏈結文字中指出此行為。', status: 'fail', message, fix_suggestion: fix, details: Array.isArray(details) ? details : [details] };
}
...
export async function check(page) {
  try {
  // 通用 DOM 查詢：在使用者請求的情況下才開出新視窗，並在鏈結文字中指出此行為。
    ...
    return { code: 'GN3320501E', rule: '在使用者請求的情況下才開出新視窗，並在鏈結文字中指出此行為。', status: 'fail', message: `執行錯誤: ${err.message}`, fix_suggestion: '確認頁面載入完成後再執行', details: [] };
  }
}
...
export const metadata = {
  ...
  level: 'AAA',
  category: 'General',
  rule: '在使用者請求的情況下才開出新視窗，並在鏈結文字中指出此行為。',
};
